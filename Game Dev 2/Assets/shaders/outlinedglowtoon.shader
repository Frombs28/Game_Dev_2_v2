Shader "Toon/VaporwaveShader" {
	...
	SubShader {
		...
		sampler2D _BumpMap; //include a bump

		sampler2D _MKGlowTex; //include mkglow
		half _MKGlowTexStrength; //include mk glow streangth
		fixed4 _MKGlowTexColor; //inlcude mk glow strength
		...
		struct Input {
			...
			float2 uv_BumpMap; //bump
			float2 uv_MKGlowTex; //MKGlow
		};
